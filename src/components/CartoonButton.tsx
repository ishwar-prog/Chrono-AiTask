  ...
  return (
    ...
    >
      <button
        ...
        disabled={disabled}
        onClick={handleClick}
        className={`relative h-12 w-full px-6 text-xl rounded-full font-bold text-neutral-800 border-2 border-neutral-800 transition-all duration-150 overflow-hidden group
        ${color} hover:shadow-[0_4px_0_0_#262626] dark:border-white dark:hover:shadow-[0_4px_0_0_#ffffff]
